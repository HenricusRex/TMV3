...
#        self.ui.tableWidget.setSelection()
    ...
    def onFillPlanID(self,par1,par2):
        ...
        self.setCell('TMV3 Version',_plan.tmv_version)
        self.setCell('KMV',_plan.kmv)
        self.setCell('Zooning',_plan.zooning)
        self.setCell('NATO',_plan.nato)
        self.setCell('Company',_plan.company)
        self.setCell('Operator',_plan.operator)
        self.setCell('Date',_plan.date)
